...
const AddTestimonialMaster=()=> {
 ...
 if(newRating==0){
    ...
    form.append('filename' ,'testimonial-'+(JSON.parse(JSON.stringify(obj.data[0]))).TestimonialId)
    ...
    status: image.status
        ...
        PostApiCall.postRequest({
            ...
            testimonialId: (JSON.parse(JSON.stringify(obj.data[0]))).TestimonialId,
                                    ...
                                    <div className="col-md-12">
                                        <nav aria-label="breadcrumb" class="float-right mt-1">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="/addtestimonialsitemmaster">Testimonial List</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">Add New Testimonial</li>
                                            </ol>
                                        </nav>
                                        <h4 class="mb-1 mt-0">Add New Testimonial </h4>
                                    </div>
                                    </div>
                                                                ...
                                                                <div className="toast fade show" role="alert" aria-live="assertive"
                                                                    ...
                                                                    <div class="toast-body">
                                                                        ...
                                                                        <div className="btn-toolbar sw-toolbar sw-toolbar-top justify-content-right" style={{ float: 'right' }}>
                                                                            ...
                                                                            //     })
                                                                            //   }}
                                                                              onClick={SaveProduct}>Add Testimonial</button>
                                                                        </div>
                                                                    </div> 
...
export default AddTestimonialMaster