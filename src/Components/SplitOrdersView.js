    ...
    <tbody>
        ...
        <td  colspan="4"></td>
                                  ...
                                  <div class="card">
                                      ...
                                      <td>{(index+1)}.</td>
                                        ...
                                        <td>&#8377;{parseFloat((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(ord.fld_offerpercent == '' || ord.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*ord.fld_offerpercent/100)))).toFixed(2)}</td>
                                          ...
                                          // parseFloat((data.fld_marginon == 'Vendor Selling Price' ? ((data.fld_vendorsellingprice[0]*data.fld_quantity)-((data.fld_marginon == 'Vendor Selling Price' ? ((data.fld_vendorsellingprice[0]*data.fld_quantity)*(data.fld_marginpercent/100)) : ((data.fld_price[1]*data.fld_quantity)*(data.fld_marginpercent/100))))) : ((data.fld_price[1]*data.fld_quantity)-((data.fld_marginon == 'Vendor Selling Price' ? ((data.fld_vendorsellingprice[0]*data.fld_quantity)*(data.fld_marginpercent/100)) : ((data.fld_price[1]*data.fld_quantity)*(data.fld_marginpercent/100)))))) - (parseFloat(((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord.fld_tcs/100))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord.fld_tds/100)))).toFixed(2)
                                        parseFloat((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))).toFixed(2)
                                          :
                                        <span>
                                          <strike>
                                            {
                                         parseFloat((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))).toFixed(2)
                                          ...
                                          parseFloat(((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data.fld_taxpercent/100)))-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100))))).toFixed(2)
                                          :
                                          <span>
                                            <strike>
                                              {
                                    ...
                                    <td>{data.fld_adjustreason}</td>
                                       ...
                                       onClick={()=>{
                                         this.setState({
                                          BMSCurrentSplit :       parseFloat(((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data.fld_taxpercent/100)))-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100))))).toFixed(2)
                                          ,
                                          VendorCurrentSplit :       parseFloat((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))).toFixed(2),
          ...
          <td>{ ord.VenDet != undefined && ord.VenDet.length > 0  ?  parseFloat(((ord.VenDet.map(data => 
           data.fld_vendornewamount == undefined ?
           // (((data.fld_marginon == 'Vendor Selling Price' ? ((data.fld_vendorsellingprice*data.fld_quantity)-((data.fld_marginon == 'Vendor Selling Price' ? ((data.fld_vendorsellingprice*data.fld_quantity)*(data.fld_marginpercent/100)) : ((data.fld_price[1]*data.fld_quantity)*(data.fld_marginpercent/100))))) : ((data.fld_price[1]*data.fld_quantity)-((data.fld_marginon == 'Vendor Selling Price' ? ((data.fld_vendorsellingprice*data.fld_quantity)*(data.fld_marginpercent/100)) : ((data.fld_price[1]*data.fld_quantity)*(data.fld_marginpercent/100)))))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord.fld_tcs/100))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord.fld_tds/100)))))
parseFloat((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))).toFixed(2)
        ...
        for(var i=0; i<this.state.VendorOrders.length;i++){
            ...
            merchantdet.push(
                ...
                "amountToBeSettled":parseFloat(((ord.VenDet.map(data => 
                  data.fld_vendornewamount == undefined ?
                  // (((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice*(data.fld_marginpercent/100)) : (data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice*(data.fld_marginpercent/100)) : (data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord.fld_tcs/100))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord.fld_tds/100)))))
      parseFloat((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))).toFixed(2)
      ...
      for(var i=0; i<this.state.VendorOrders.length;i++){
        ...
        for(var j=0; j<this.state.VendorOrders[i].VenDet.length;j++){
          ...
          PostApiCall.postRequest({
            ...
            vendorsplitamount :parseFloat((data1.fld_marginon == 'Vendor Selling Price' ? (data1.fld_quantity*data1.fld_vendorsellingprice[0]-((data1.fld_marginon == 'Vendor Selling Price' ? (data1.fld_quantity*data1.fld_vendorsellingprice[0]*(data1.fld_marginpercent/100)) : (data1.fld_quantity*data1.fld_price[1]*(data1.fld_marginpercent/100))))) : (data1.fld_quantity*data1.fld_price[1]-((data1.fld_marginon == 'Vendor Selling Price' ? (data1.fld_quantity*data1.fld_vendorsellingprice[0]*(data1.fld_marginpercent/100)) : (data1.fld_quantity*data1.fld_price[1]*(data1.fld_marginpercent/100)))))) - ((((((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100)))).toFixed(2),

            bmssplitamount :       parseFloat(((((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data1.fld_taxpercent/100)))-((data1.fld_marginon == 'Vendor Selling Price' ? (data1.fld_quantity*data1.fld_vendorsellingprice[0]-((data1.fld_marginon == 'Vendor Selling Price' ? (data1.fld_quantity*data1.fld_vendorsellingprice[0]*(data1.fld_marginpercent/100)) : (data1.fld_quantity*data1.fld_price[1]*(data1.fld_marginpercent/100))))) : (data1.fld_quantity*data1.fld_price[1]-((data1.fld_marginon == 'Vendor Selling Price' ? (data1.fld_quantity*data1.fld_vendorsellingprice[0]*(data1.fld_marginpercent/100)) : (data1.fld_quantity*data1.fld_price[1]*(data1.fld_marginpercent/100)))))) - ((((((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tcs/100))) - ((((((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data1.fld_price[0]*data1.fld_quantity)/(1+(data1.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord.fld_tds/100))))).toFixed(2)
            ,
  ...
  for(var i=0; i<this.state.VendorOrders.length;i++){
    ...
    PostApiCall.postRequest({
     ...
     vendorsplitamount : parseFloat(((ord2.VenDet.map(data => 
      data.fld_vendornewamount == undefined ?
      // (((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice*(data.fld_marginpercent/100)) : (data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_vendorsellingprice*(data.fld_marginpercent/100)) : (data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord2.fld_tcs/100))) - ((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*(ord2.fld_tds/100)))))
    parseFloat((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord2.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord2.fld_tds/100)))).toFixed(2)
      ...
      bmssplitamount : parseFloat(ord2.VenDet.map(data => 
        data.fld_vendornewamount == undefined ?
     parseFloat(((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))+((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100)))*(data.fld_taxpercent/100)))-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100))))) : (data.fld_quantity*data.fld_price[1]-((data.fld_marginon == 'Vendor Selling Price' ? (data.fld_quantity*data.fld_vendorsellingprice[0]*(data.fld_marginpercent/100)) : (data.fld_quantity*data.fld_price[1]*(data.fld_marginpercent/100)))))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord2.fld_tcs/100))) - ((((((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100))-(this.state.MainOrder.fld_offerpercent == '' || this.state.MainOrder.fld_offerpercent == null ? 0 : ((data.fld_price[0]*data.fld_quantity)/(1+(data.fld_taxpercent/100)))*this.state.MainOrder.fld_offerpercent/100))))*(ord2.fld_tds/100))))).toFixed(2)
